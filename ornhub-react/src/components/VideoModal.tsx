...
interface VideoModalProps {
  ...
  onDeleteComment: (moduleId: string, commentIndex: number) => void;
}
...
const VideoModal: React.FC<VideoModalProps> = ({
  ...
  const handleSubmitComment = () => {
    ...
    onAddComment(moduloId, commentText);
    setCommentText('');
  };
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (window.confirm('¿Eliminar comentario?')) {
                              onDeleteComment(moduloId, commentIdx);
                            }
                          }}
                        >
                          Eliminar
